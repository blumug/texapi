...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Text.url'
        db.alter_column(u'text_text', 'url', self.gf('django.db.models.fields.CharField')(max_length=2048))

    def backwards(self, orm):

        # Changing field 'Text.url'
        db.alter_column(u'text_text', 'url', self.gf('django.db.models.fields.CharField')(max_length=512))
